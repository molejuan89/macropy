...
function contenido(action) {
    ...
    if (action == "Create_CE") {
        htmlcontent = " <div class=\"container-fluid well\">\n\
                                <div class=\"row\">\n\
                                    <div class=\"col-xs-5\">\n\
                                        <h4>\n\<a><strong> Create Comprobante de Egreso</strong></a>\n\</h4>\n\
                                ...
                                <div class=\"row\">\n\
                                    ...
                                    <div class=\"row\">\n\
                                    <div class=\"col-xs-6\">\n\
                                        <label for=\"txt_RecibidoDe\">Pagado a:</label>\n\
...
";
    }   else  if (action == "Read/Disable_CE") {
         htmlcontent = " <div class=\"container-fluid well\">\n\
                                <div class=\"row\">\n\
                                    <div class=\"col-xs-7\">\n\
                                        <h4>\n\<a><strong> Read/Disable Comprobante de Egreso</strong></a>\n\</h4>\n\
                                    </div>\n\
                                    <div class=\"col-xs-2\">\n\</div>\n\
                                    <div class=\"col-xs-3\">\n\
                                        <label for=\"txt_lugarCIngreso\">Buscar Consecutivo:</label>\n\
