...
<html>
    <head>
        ...
        <script src="js/div-contenido_CI.js"></script>
        <script src="js/div-contenido_CE.js"></script>
    ...
    <body><br>
        ...
        <a onkeyup="fecha();"></a>
                ...
                <div id="collapse2" class="panel-collapse collapse">
                    <div class="panel-body">
                        <form id="InformacionPersonal" method="post"  action="#">
                            <div class="container-fluid">
                                <div class="row">
                                    <a href="javascript:contenido('Create_CE');" >Crear</a><br>
                                    <a href="javascript:contenido('Read/Disable_CE');" >Consultar</a><br>
                                </div>
                            </div>
                        </form>
                    </div>
            ...
            <div class="panel panel-default">
                <div class="panel-heading"  >
                    <h4 class="panel-title" >
                        <a data-toggle="collapse" data-parent="#accordion" href="#collapse5"  style="color: red"><strong>Mantenimiento General:</strong></a>
                    </h4>
                </div>
            ...
            <div class="panel panel-default">
                <div class="panel-heading"  >
                    <h4 class="panel-title" >
                        <a data-toggle="collapse" data-parent="#accordion" href="#collapse6"  style="color: red"><strong>Consultas:</strong></a>
                    </h4>
                </div>
